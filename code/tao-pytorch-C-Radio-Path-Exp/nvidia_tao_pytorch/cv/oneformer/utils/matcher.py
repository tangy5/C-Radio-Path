...
"""Hungarian matching algorithms for OneFormer model.

This module implements matching algorithms used in the OneFormer model
for associating predicted segments with ground truth annotations during training.
"""
...
def linear_sum_assignment_with_nan(cost_matrix):
    """Handle linear sum assignment with NaN values in cost matrix.

    Args:
        cost_matrix: Cost matrix that may contain NaN values

    Returns:
        Tuple of (row_indices, col_indices) from linear assignment
    """
