...
# TODO : cc says this is never used
...
class OCDnetModel(TAOLightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        # TODO : the code coverage report shows that we never test the ema mode at all
        if save_best_ema:
    ...
    # TODO : is this function necessary? It seems like on_validation_epoch_end is manually saving, but we have a callback for this?
