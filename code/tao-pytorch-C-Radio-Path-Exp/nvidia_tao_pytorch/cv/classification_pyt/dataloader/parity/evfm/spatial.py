...
"""Reference parity dumpt for spatial transforms and pipeline builder.
...
def dump_scale_transform():
    from data.transforms.transforms import Size, ScaleTransform
...
def dump_max_size_transform():
    from data.transforms.transforms import Size, MaxSizeTransform
    from data.transforms.defer_image import DeferImage
    from data.transforms.quad import Quad
...
def dump_center_crop_transform():
    from data.transforms.transforms import Size, CenterCropTransform
    from data.transforms.defer_image import DeferImage
    from data.transforms.quad import Quad
...
def dump_random_crop_transform():
    from data.transforms.transforms import Size, RandomCropTransform
    from data.transforms.defer_image import DeferImage
    from data.transforms.quad import Quad
...
def dump_random_zoom_transform():
    from data.transforms.transforms import RandomZoomTransform
    from data.transforms.defer_image import DeferImage
    from data.transforms.quad import Quad
...
def dump_random_flip_transform():
    from data.transforms.transforms import RandomFlipTransform
    from data.transforms.defer_image import DeferImage
    from data.transforms.quad import Quad
...
def dump_random_rotation_transform():
    from data.transforms.transforms import RandomRotationTransform
    from data.transforms.defer_image import DeferImage
    from data.transforms.quad import Quad
...
def dump_pad_to_transform():
    from data.transforms.transforms import Size, PadToTransform
    from data.transforms.defer_image import DeferImage
    from data.transforms.quad import Quad
