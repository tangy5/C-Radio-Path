...
"""Reference parity dumps for data/misc/ components.
...
def dump_fast_to_tensor():
    from data.misc.fast_to_tensor import fast_to_tensor
...
def dump_mixture_emitter():
    from data.misc.mixture_emitter import MixtureEmitter
...
def dump_weighted_reservoir():
    from data.misc.weighted_streaming_sampler import WeightedWSWoRReservoir
