...
class Dataset:
    ...
    root_dir: str = "<SHARED_SCRATCH_MOUNT>/<user>/datasets"
    panoptic_json: str = "coco/annotations/panoptic_train2017.json"
    instance_json: str = "coco/annotations/instance_train2017.json"
    instance_root: str = "<SHARED_SCRATCH_MOUNT>/<user>/datasets/coco/train2017"
    panoptic_root: str = "<SHARED_SCRATCH_MOUNT>/<user>/datasets/coco/panoptic_train2017"
