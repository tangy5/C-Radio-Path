            ...
            aug_kwargs.update(
                {
                    ...
                    "use_gpu_color_aug": augmentation.get("use_gpu_color_aug", False),
                    ...
                    "random_noise": augmentation.get("random_noise"),
                    "grayscale_prob": augmentation.get("grayscale_prob", 0.0),
                }
            )
